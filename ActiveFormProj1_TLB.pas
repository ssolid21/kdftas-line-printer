...
// PASTLWTR : 1.2
// File generated on 2021-01-31 오후 3:14:35 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\경동물류\03.개발\ActiveX\ActiveFormProj1.tlb (1)
// LIBID: {1A4834F3-28BF-4E46-BB25-7E975CCBECD7}
// LCID: 0
// Helpfile: 
...
const
  ...
  LIBID_ActiveFormProj1: TGUID = '{1A4834F3-28BF-4E46-BB25-7E975CCBECD7}';

  IID_IActiveFormX: TGUID = '{48E80D30-F629-4670-9CEF-D93A87EA2F38}';
  DIID_IActiveFormXEvents: TGUID = '{033A62F1-63F4-42F7-B468-F4D99F544321}';
  CLASS_ActiveFormX: TGUID = '{E0A53274-D311-4BC9-AE96-26C138156BBC}';
...
// GUID:      {48E80D30-F629-4670-9CEF-D93A87EA2F38}
// *********************************************************************//
  IActiveFormX = interface(IDispatch)
    ['{48E80D30-F629-4670-9CEF-D93A87EA2F38}']
...
// *********************************************************************//
  IActiveFormXDisp = dispinterface
    ...
    procedure Init; dispid 217;
    procedure AddData(const Param1: WideString); dispid 218;
    procedure Print; dispid 219;
  end;

// *********************************************************************//
// DispIntf:  IActiveFormXEvents
// Flags:     (4096) Dispatchable
// GUID:      {033A62F1-63F4-42F7-B468-F4D99F544321}
// *********************************************************************//
  IActiveFormXEvents = dispinterface
    ['{033A62F1-63F4-42F7-B468-F4D99F544321}']
...
// *********************************************************************//
  ...
  public
    procedure Init;
    procedure AddData(const Param1: WideString);
    procedure Print;
...
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{E0A53274-D311-4BC9-AE96-26C138156BBC}';
    EventIID: '{033A62F1-63F4-42F7-B468-F4D99F544321}';
    EventCount: 8;
...
begin
  DefaultInterface.AddData(Param1);
end;
